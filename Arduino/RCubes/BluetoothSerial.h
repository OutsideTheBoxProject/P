...
public:
  ...
  char* getRemoteName(const char* device_mac); // returns the name of a given mac
  void connectTo(const char* device_mac); // connect to a given device
